...
<body>
    ...
    <div id="container" style="margin-top:50px;margin-left:auto;margin-right:auto;">
        <div>
            <h3 style="text-align:center;"><b>My Calendar</b></h3>
        </div>
        <div id="header" style="margin-top:60px;">
            <div id="monthDisplay"></div>
            <div>
                <a href="welcome.php"><i data-toggle="tooltip" data-placement="left" title="Home Page"
                        class="fas fa-home" style="font-size:30px;" id="homebtn"></i></a>
    ...
    <div class="modal fade" id="showstage1tasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <!-- ######################################################################################################################################### -->
    <!--Safe Task Modal -->
    <div class="modal fade" id="showssafetasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="showsdeadlineapptasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog alltaskm" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="showsdeadlinepasstasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog alltaskm" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- ######################################################################################################################################### -->
    <!--All Tasks Modal -->
    <div class="modal fade" id="showalltasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog alltaskm" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="vacationplanmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="ooo_form" method="get">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="vstart" placeholder="Vacation Start"
                                name="vstart">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary createooo1" name="createooo"
                            id="createooo">Save</button>
    ...
    <!-- ######################################################################################################################################### -->
    <!-- Remarks modal -->
    <div class="modal fade" id="remarksmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog alltaskm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="cancel_form" method="get">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="vguid" placeholder="VGUID" name="vguid"
                                style="display:none;">
                        </div>
                        ...
                        <button type="button" class="btn btn-secondary close1" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger cancelooo" name="cancelooo" id="cancelooo">Cancel
                            Vacation</button>
