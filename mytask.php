  ...
  ?>
      <tr>
        ...
        <td><?php echo $row['tdescription']; ?></td>
         <td style="width:200px;"><button  type="submit" class="btn btn-success stpbtn12" id="stepbtn12" style="text-align:left;color: black;font-weight:700;text-decoration: underline; border-color:white">
          <?php
         $ttype=$row['ttype'];
