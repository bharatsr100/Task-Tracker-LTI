    ...
    <div style="margin: auto;width: 60%;">
        ...
        <form id="register_form" name="form1" method="post" style="margin-top:50px;display:none;">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="e_emailid" placeholder="Employee Email ID"
                    name="e_emailid">
            </div>
            <div class="form-group">
        ...
        <form id="login_form" name="form1" method="post">
            ...
            <div style="margin-top:50px;" class="form-group">
                <label title="Use Employee Number, Employee Email ID, Project Email ID or Contact Number as User ID"
                    for="userid">User ID:
                </label>
