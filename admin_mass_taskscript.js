...
function CSV2JSON(csv) {
  ...
  //                         for (var j = 0; j < cells.length; j++) {
  //                             var cell = row.insertCell(j);
  //                             cell.innerHTML = "<th><b>"+cells[j]+"</b></th>";
  //                         }
  //                         var cell = row.insertCell(j);
  ...
  function upload_data(){
    // sessionStorage.setItem("tguid", tguid);
     // var json_tasks = sessionStorage.getItem("json_tasks");
     // var json_alltasks = JSON.parse(json_tasks);
     // var json_alltasks= alltasks;
     // console.log("Hello");
     // console.log(json_alltasks);
